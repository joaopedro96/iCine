//
//  CNOnboardingFooterSectionView.swift
//  iCine
//
...
protocol CNOnboardingFooterSectionViewDelegate: AnyObject {
    func didTapSignInButton()
    func didTapSignUpButton()
}

final class CNOnboardingFooterSectionView: UIView {
    
    // MARK: - PROPERTIES
    
    weak var delegate: CNOnboardingFooterSectionViewDelegate?
